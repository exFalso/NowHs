{-# LANGUAGE KindSignatures, DataKinds, TypeOperators, MultiParamTypeClasses, FunctionalDependencies, FlexibleInstances, UndecidableInstances, GADTs, ConstraintKinds #-}
module Util where
